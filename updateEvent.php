...
if($validForm)
{
	...
	//$eventTime = date("h:i:00");
		...
		$sql = "UPDATE final_event SET 
		event_name = '$eventName', 
		event_description = '$eventDescription',  
		event_date = '$date', 
		event_time = '$time',
		event_location = '$eventLocation'
		WHERE event_id= '$recID'";
...
<div class="container">
<form id="eventsForm" name="eventsForm" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?recID=$recID"; ?>">
  ...
  <p>
    <input type="submit" name="submit" id="button3" value="Update Event">
